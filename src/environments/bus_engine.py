...
if __name__ == '__main__':
    ...
    # TOTAL TIME TAKEN FOR VALUE ITERATION - 113.13 s STATE SPACE SIZE: 100
    # TOTAL TIME TAKEN FOR VALUE ITERATION - 236.28 s STATE SPACE SIZE: 200
    # TOTAL TIME TAKEN FOR VALUE ITERATION - 364.99 s STATE SPACE SIZE: 300
    # TOTAL TIME TAKEN FOR VALUE ITERATION - 498.49 s STATE SPACE SIZE: 400
    # TOTAL TIME TAKEN FOR VALUE ITERATION - 636.71 s STATE SPACE SIZE: 500
    # TOTAL TIME TAKEN FOR VALUE ITERATION - 792.60 s STATE SPACE SIZE: 600
    # TOTAL TIME TAKEN FOR VALUE ITERATION - 949.24 s STATE SPACE SIZE: 700
    # TOTAL TIME TAKEN FOR VALUE ITERATION - 1142.97 s STATE SPACE SIZE: 800
    # TOTAL TIME TAKEN FOR VALUE ITERATION - 1260.07 s STATE SPACE SIZE: 900
    # TOTAL TIME TAKEN FOR VALUE ITERATION - 1579.11 s STATE SPACE SIZE: 1000
